...
function NotesPanel({ plantId }) {
  return <div className="p-4 bg-white/40 rounded-lg">Notes for plant {plantId}</div>;
}

function StudyListManager({ plantId }) {
  return <div className="p-4 bg-white/40 rounded-lg">Study list for plant {plantId}</div>;
}
...
>>>>>>> Stashed changes
              ...
              <div className="flex-1">
                ...
                <p className="text-green-800 mt-1 italic">{plant.scientific_name}</p>

                <div className="mt-4 flex gap-3">
                  <button
                    onClick={speakPlantInfo}
                    className={`rounded-full px-4 py-2 text-sm flex items-center gap-2 shadow ${
                      isSpeaking
                  ...
                  <button
                    ...
                    className="rounded-full px-4 py-2 text-sm flex items-center gap-2 shadow bg-blue-700 hover:bg-blue-800 text-white"
                  >
                ...
                {plant.video && (
                  <div className="mt-4">
                    <p className="font-semibold text-green-900 mb-2">📺 Watch Video</p>
